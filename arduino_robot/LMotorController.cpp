...
LMotorController::LMotorController(int ena, int in1, int in2, int enb, int in3, int in4, double motorAConst, double motorBConst)
{
	...
	// prh - reverse 1/2 and 3/4 to change direction to opposite of original project (my robot faces opposite direction)
	// and reversed A12 and B34 because my wheels are opposite sides
